...
def prepare_data():
    '''
    The movie data store is hard coded here for now.
    ...
    sholay = media.Movie("Sholay",
                         ...
                         "wikipedia/en/thumb/"
                         "5/52/Sholay-poster.jpg/"
                         "220px-Sholay-poster.jpg",
    ...
    midnight_in_paris = media.Movie("Midnight in paris",
                                    ...
                                    "220px-Midnight_in_Paris_Poster.jpg",
                                    "https://www.youtube.com/"
                                    "watch?v=BYRWfS2s2v4")
    hunger_games = media.Movie("Hunger Games",
                               "Hunger Games Description",
                               "https://upload.wikimedia.org/"
                               "wikipedia/en/thumb/4/"
                               "42/HungerGamesPoster.jpg/"
                               "220px-HungerGamesPoster.jpg",
                               "https://www.youtube.com/watch?v=4S9a5V9ODuY")

    # making a list of all the movie objects
    data_list = [munna_bhai, gabbar, bahubali, dangal, sholay,
                 mrs_doubtfire, toy_story, avatar, school_of_rock,
